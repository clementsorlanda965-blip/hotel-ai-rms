...
After extracting all tasks from the plan, **present the task list and dispatch order to the user** for confirmation before dispatching any subagents. This ensures:

- The user agrees the task decomposition matches their intent
- The execution order is correct
- The user has a chance to adjust before work begins

Wait for explicit user consent before proceeding to the first dispatch.
...
[User confirms — proceed to dispatch]
