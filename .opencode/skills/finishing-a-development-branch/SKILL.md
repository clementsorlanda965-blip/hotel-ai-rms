...
description: 开发分支收尾——实现完成且所有测试通过后，提供合并、提PR或清理等结构化选项，指导开发工作的收尾与整合。输入"完成开发""提交代码""合并分支"时触发。
---
...
| 资源 | 用途 |
|------|------|
| `test-prompts.json` | 测试用例（合并/PR/丢弃三种场景），用于验证技能效果 |
| `using-git-worktrees` skill | worktree 创建/检测/清理的底层实现 |
| `finishing-a-development-branch` skill 目录 | SKILL.md 主文件 + 测试数据 |
