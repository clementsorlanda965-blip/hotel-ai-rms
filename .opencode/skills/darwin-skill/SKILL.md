---
name: darwin-skill
description: 达尔文技能自优化——8维度评估SKILL.md（结构+效果），hill-climbing自动优化+git版本控制，实测验证改进效果，生成可视化成果卡片。灵感来自Karpathy autoresearch。输入"优化skill""skill评分""自动优化""skill质量检查""达尔文""darwin""帮我改改skill""skill怎么样""提升skill质量""skill review""skill打分"时触发。
---
